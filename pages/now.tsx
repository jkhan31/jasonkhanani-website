      ...
      <div className="min-h-screen p-4 md:p-8 lg:p-12 animate-in slide-in-from-bottom-4 duration-700">
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-12">
            <h1 className="text-4xl md:text-5xl font-sans font-bold tracking-tight mb-4 text-darkText">Now</h1>
          ...
          {/* What I'm Working On */}
          <section className="mb-16 pb-12 border-b border-0.5 border-darkText/10">
            <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-warmAmber mb-6">What I'm Working On</h2>
            <div className="space-y-5 text-base leading-relaxed text-darkText/75">
              <div>
                <h3 className="font-bold text-darkText mb-2">Repositioning the website</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-darkText mb-2">Building a writing practice</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-darkText mb-2">Exploring new freelance models</h3>
                <p>
          ...
          <section className="mb-16 pb-12 border-b border-0.5 border-darkText/10">
            <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-warmAmber mb-6">Available For</h2>
            <ul className="space-y-4 text-base text-darkText/75">
          ...
          <section className="mb-16">
            <h2 className="text-sm font-bold uppercase tracking-[0.15em] text-warmAmber mb-6">What I'm Thinking About</h2>
            <div className="space-y-5 text-base leading-relaxed text-darkText/75">
              <div>
                <h3 className="font-bold text-darkText mb-2">Requirements as a bottleneck, not a solution</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-darkText mb-2">How to diagnose a system</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-darkText mb-2">Building for clarity</h3>
                <p>
          ...
          {/* CTA */}
          <section className="py-12 border-t border-0.5 border-darkText/10">
            <p className="text-base text-darkText/75 mb-6">
