    ...
    <>
      ...
      <div className="min-h-screen p-4 md:p-8 lg:p-12 animate-in slide-in-from-bottom-4 duration-700">
        <div className="max-w-3xl mx-auto">
          {/* Opening Statement */}
          <div className="mb-20">
            <p className="text-xl leading-relaxed text-darkText mb-6">
          ...
          <div className="mb-20">
            ...
            <ul className="space-y-3 list-none text-base text-bodyText mb-8">
          ...
          <section className="py-12" id="contact">
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              <a
                ...
                className="flex items-center gap-2 px-8 py-4 bg-warmAmber text-cardBg text-sm font-bold tracking-[0.15em] uppercase rounded-full hover:bg-diagnosticBlue transition-colors duration-300"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 px-8 py-4 border border-darkText/30 text-darkText text-sm font-bold tracking-[0.15em] uppercase rounded-full hover:bg-diagnosticBlue hover:text-cardBg hover:border-diagnosticBlue transition-colors duration-300"
              >
