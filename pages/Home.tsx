          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            {[
              ...
              <div key={i} className="group">
                <h4 className="text-ricePaper font-bold text-xs uppercase tracking-widest mb-2">{s.title}</h4>
          ...
          <div className="w-full h-full flex flex-col justify-center gap-6 px-6">
            {[
              ...
              <div key={i} className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-ricePaper font-bold text-sm uppercase tracking-widest">{s.title}</h4>
                  <p className="text-ricePaper/70 text-sm">{s.short}</p>
                </div>
              </div>
            ))}
          </div>
...
const ExecutionTracks: React.FC = () => (
  <section className="px-6 py-24 md:py-40 max-w-7xl mx-auto">
    <SectionHeader eyebrow="Execution Tracks" title="How I Build Leverage." className="mb-20 text-center" />
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
      <div className="p-12 md:p-20 border-0.5 border-hankoRust/20 bg-white relative group hover:border-hankoRust/60 transition-all duration-500">
        ...
        <p className="text-xl text-sumiInk/70 font-serif leading-relaxed mb-12">I dive into your Postgres/BigQuery instances to find where revenue is leaking and why process owners are stuck.</p>
        <ul className="space-y-4 mb-12">
          {['Revenue Forensics', 'SQL Data Modeling', 'Scenario Sensitivity Analysis'].map((s) => (
      ...
      <div className="p-12 md:p-20 border-0.5 border-hankoRust/20 bg-white relative group hover:border-hankoRust/60 transition-all duration-500">
        ...
        <p className="text-xl text-sumiInk/70 font-serif leading-relaxed mb-12">Operational blueprinting. I design the automations and documentation that allow teams to scale without adding headcount.</p>
        <ul className="space-y-4 mb-12">
          {['Async Workflow Design', 'Automated Ops Pipelines', 'Distributed System Resilience'].map((s) => (
            <li key={s} className="flex items-center text-xs font-bold uppercase tracking-widest text-sumiInk/40">
